function onUse(cid, item, fromPosition, itemEx, toPosition)
	if item.actionid >= 9933 and item.actionid <= 9933 and getPlayerStorageValue(cid, 9933) ~= 1 then
		local reward = 0
		if item.actionid == 9933 then
			reward = doCreateItemEx(1993,1)
			doAddContainerItem(reward, 9933, 1)
			doAddContainerItem(reward, 8305, 1)
