function onUse(cid, item, fromPosition, itemEx, toPosition)
	if item.actionid >= 2656 and item.actionid <= 2656 and getPlayerStorageValue(cid, 2656) ~= 1 then
		local reward = 0
		if item.actionid == 2656 then
			reward = doCreateItemEx(1987,1)
			doAddContainerItem(reward, 2656, 1)
			doAddContainerItem(reward, 7730, 1)
			doAddContainerItem(reward, 2663, 1)
