...
local pokes = {
["Dragon"] = {level = 40, go = "Vai Dragon", back = "Volte Dragon."},
["Demon"] = {level = 110, go = "Vai Demon", back = "Volte Demon."},
["Dragon Lord"] = {level = 70, go = "Vai Dragon Lord", back = "Volte Dragon Lord."},
}
