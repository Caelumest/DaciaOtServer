...
function creatureSayCallback(cid, type, msg)
        ...
        local sorrymessage = "Sorry, you don't have enough dusts to progress in rank..."
        local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and 0 or cid
        if msgcontains(msg, 'mission') then
                if getstorage == 6 then
                        npcHandler:say("You are the highest demon hunter rank now.", cid)
                elseif getstorage < 6 then
                        npcHandler:say("Would ye' like to give me demon dusts?", cid)
                ...
                if talkState[talkUser] == 1 then
                        if getstorage < 0 then
                                if doPlayerRemoveItem(cid, tokenid, 1) == TRUE then
                                        npcHandler:say("Ye' brought the demon dusts needed to advance to the first demon hunter rank. I consider that a fluke, but still, congrats! Let me share some of my experience with ye'.", cid)
                        ...
                        elseif getstorage == 3 then
                                if doPlayerRemoveItem(cid, tokenid, 10) == TRUE then
                                        npcHandler:say("Ye' brought the ten demon dusts needed to advance to the fourth demon hunter rank. You're absolutely painstaking! Let me share some of my experience with ye'.", cid)
                        ...
                        elseif getstorage == 4 then
                                if doPlayerRemoveItem(cid, tokenid, 30) == TRUE then
                                        npcHandler:say("Ye' brought the thirty demon dusts needed to advance to the fifth demon hunter rank. You're completely obliterative, kid! Let me share some of my experience, my armor, magic crystal and a refine stone with ye'.", cid)
                        ...
                        elseif getstorage == 5 then
                                if doPlayerRemoveItem(cid, tokenid, 50) == TRUE then
                                        npcHandler:say("Ye' brought the fifty demon dusts needed to advance to the last demon hunter rank. Now that's something. You're razing-amazing! Let me share some of my experience, my helmet, my sword and a refine stone with ye'!", cid)
                                        setPlayerStorageValue(cid, storage, 6)
                                        doPlayerAddExp(cid, 100000)
                                        doPlayerAddItem(cid, 5924, 1)
                                        doPlayerAddItem(cid, 2400, 1)
                                        doPlayerAddItem(cid, 11138, 1)
                                        doPlayerAddItem(cid, 8305, 1)
                                        talkState[talkUser] = 0
        ...
        elseif(msgcontains(msg, 'no') and talkState[talkUser] == 1) then
                npcHandler:say("Sure, come back when ye'll have enough demon dusts.", cid)
                talkState[talkUser] = 0
        end
return TRUE
end
