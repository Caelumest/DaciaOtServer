...
function creatureSayCallback(cid, type, msg)
        ...
        if msgcontains(msg, 'mission') then
                ...
                elseif getstorage < 6 then
                        npcHandler:say("Would ye' like to give me fire swords?", cid)
                ...
                if talkState[talkUser] == 1 then
                        if getstorage < 0 then
                                if doPlayerRemoveItem(cid, tokenid, 1) == TRUE then
                                        npcHandler:say("Ye' brought the fire sword needed to advance to the first rank. I consider that a fluke, but still, congrats! Let me share some of my experience with ye'.", cid)
                        ...
                        elseif getstorage == 1 then
                                if doPlayerRemoveItem(cid, tokenid, 3) == TRUE then
                                        npcHandler:say("Ye' brought three fire sword needed to advance to the second rank. I consider that a fluke, but still, congrats! Let me share some of my experience with ye'.", cid)
                        ...
                        elseif getstorage == 2 then
                                if doPlayerRemoveItem(cid, tokenid, 5) == TRUE then
                                        npcHandler:say("Ye' brought five fire swords needed to advance to the third rank. I consider that a fluke, but still, congrats! Let me share some of my experience with ye'.", cid)
                        ...
                        elseif getstorage == 3 then
                                if doPlayerRemoveItem(cid, tokenid, 10) == TRUE then
                                        npcHandler:say("Ye' brought the ten fire swords needed to advance to the fourth rank. You're absolutely painstaking! Let me share some of my experience with ye'.", cid)
                        ...
                        elseif getstorage == 4 then
                                if doPlayerRemoveItem(cid, tokenid, 15) == TRUE then
                                        npcHandler:say("Ye' brought the fifteen fire swords needed to advance to the fifth rank. You're completely obliterative, kid! Let me share some of my experience with ye'.", cid)
                        ...
                        elseif getstorage == 5 then
                                if doPlayerRemoveItem(cid, tokenid, 20) == TRUE then
                                        npcHandler:say("Ye' brought the twenty fire swords needed to advance to the last rank. Now that's something. You're razing-amazing! Let me share some of my experience and a little something with ye'!", cid)
                                        setPlayerStorageValue(cid, storage, 6)
                                        doPlayerAddExp(cid, 100000)
                                        doPlayerAddItem(cid, 7894, 1)
                                        doPlayerAddItem(cid, 2196, 1)
                                        doPlayerAddItem(cid, 11128, 1)
                                        doPlayerAddItem(cid, 8305, 1)
                                        talkState[talkUser] = 0
        ...
        elseif(msgcontains(msg, 'no') and talkState[talkUser] == 1) then
                npcHandler:say("Sure, come back when ye'll have enough fire swords.", cid)
                talkState[talkUser] = 0
        end
return TRUE
end
